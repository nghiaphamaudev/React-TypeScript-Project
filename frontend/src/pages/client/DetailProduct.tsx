...
const DetailProduct = () => {
  ...
  return (
    <div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            ...
            <div className="mt-6 sm:mt-8 lg:mt-0">
              <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                {product?.name} {product?.monitor}" All-In-One Computer, 256GB
                SSD, Mac OS, Pink
              </h1>
                  ...
                  <div className="flex items-center gap-1">
                    {arrayStar.map((currentValue) => {
                      if (
                        ...
                        product.ratingsAverage >= currentValue
                      )
                        return (
                          <StarIcon
                            key={currentValue}
      ...
      {/* Reviews */}
      <>
        <ul className="flex border-b mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16  border-t-2 border-slate-50">
              ...
              <div className="gap-3 pb-6 sm:flex sm:items-start">
                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                    ...
                    Very fast, and the colour matches my office set up
                    perfectly. The display is out of this world and I’m very
              ...
              <div className="gap-3 py-6 sm:flex sm:items-start">
                ...
                <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                  <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                    ...
                    fast, batteries last more than usual, everything runs
                    perfect in this computer. Highly recommend!
                  </p>
