        ...
        <div className="mt-6 sm:mt-8 px-6 lg:flex lg:items-start lg:gap-12 xl:gap-12">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  <Button symbol={<AddIcon />} title="Add new address" />
                </div>
              </div>
            </div>
            <div className="space-y-4">
          ...
          <div className="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
            ...
            <div className="space-y-3">
              <Button symbol={undefined} title="Proceed to Payment" />
              <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
                One or more items in your cart require an account.{' '}
                <a
                  href="#"
                  title=""
                  className="font-medium text-sky-600 underline hover:no-underline dark:text-sky-600"
                >
